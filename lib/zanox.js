  ...
  module.exports = function(connectId, secretKey, client) {
    ...
    return api = {
      ...
      getProducts: function(params, next) {
        return api.sendRequest('GET', '/products', params, next);
      },
      getProduct: function(id, next) {
        return api.sendRequest('GET', '/products/product/' + id, {}, next);
      },
      ...
      getAllSalesOfDate: function(date, params, next) {
        ...
        fetch = function(page, items, next) {
          var fetchParams;
          return fetchParams = _.extend({}, params, {
            items: items,
            page: page
